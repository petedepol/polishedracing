...
export const palmares: Row[] = [
  ...
  { pos: 'P1', rider: 'Gee + Rachel Atherton', event: 'World Cup · Fort William · home double on the new GT Fury I helped develop', disc: 'DH', result: 'DOUBLE WIN', medal: 'WIN', year: '2013', role: 'GT FR · head mechanic' },
  { pos: 'P1', rider: 'Gee + Rachel Atherton', event: 'World Cup · Cairns · double win, by 4 s and 11 s', disc: 'DH', result: 'DOUBLE WIN', medal: 'WIN', year: '2014', role: 'GT FR · head mechanic' },
  { pos: 'P1', rider: 'Rachel Atherton', event: 'World Cup · Fort William · first ever win for Atherton Bikes, 3D-printed titanium lugs', disc: 'DH', result: 'WIN', medal: 'WIN', year: '2019', role: 'Atherton Bikes · head mechanic' },
